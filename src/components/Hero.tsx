...
export function Hero({ language }: HeroProps) {
  ...
  return (
    <section 
      id="hero" 
      className="min-h-screen flex items-center pb-28 mt-5 px-6 bg-gradient-to-br from-white via-blue-50/30 to-teal-50/30 dark:from-gray-900 dark:via-gray-800/90 dark:to-gray-900 relative overflow-hidden"
    >
